...
Flow Album 是一个基于 Cloudflare 技术栈构建的私人云相册应用，提供安全的照片和视频存储、管理和浏览功能。用户可以通过密码保护访问自己的媒体文件，支持上传、下载、删除和批量操作。
...
4. **在 Cloudflare Pages 项目绑定R2和kv空间：**
   - ---必选步骤---：
     - 变量名称: `R2`
